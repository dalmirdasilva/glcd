...
#define LCD_DATAPORT      PORTA // MCU port connected to LCD data pins
#define LCD_DATA_IN	  PINA  // Place to read data in
#define LCD_DPDIRECTION   DDRA  // direction reg for data/command port data 1=out 0=in (A0)
